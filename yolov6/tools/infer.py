...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--weights', type=str, default='/media/nsl6/hdd1/mredul/object_detection/YOLOv6/aug_it1/exp26/weights/best_ckpt.pt', help='model path(s) for inference.')
    ...
    parser.add_argument('--yaml', type=str, default='/media/nsl6/hdd1/mredul/object_detection/YOLOv6/data/bd.yaml', help='data yaml file.')
    parser.add_argument('--img-size', nargs='+', type=int, default=[1024, 1024], help='the image-size(h,w) in inference size.')
