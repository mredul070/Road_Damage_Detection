...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--data-path', default='./data/bd.yaml', type=str, help='path of dataset')
    parser.add_argument('--conf-file', default='./configs/yolov6m.py', type=str, help='experiments description file')
    parser.add_argument('--img-size', default=1024, type=int, help='train, val image size (pixels)')
    parser.add_argument('--batch-size', default=6, type=int, help='total batch size for all GPUs')
    ...
    parser.add_argument('--output-dir', default='aug_it1', type=str, help='path to save outputs')
